...
\begin{document}
    ...
    \begin{header}
        ...
        \AND
        \kern 5.0 pt
        \mbox{\hrefWithoutArrow{tel:+91-94605-35516}{
            \faPhone\hspace{0.15 cm}{+91 9460535516}
        }}
    \end{header}
    \vspace{0.2 cm}
    ...
    % \section{Experience}
    %     \begin{twocolentry}{Sept 2003 – Apr 2005}
    %         \textbf{Lead Student Ambassador}, Microsoft -- Redmond, WA
    %     \end{twocolentry}
    %     \vspace{0.1 cm}
